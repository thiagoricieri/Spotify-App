...
public class AppProvider extends ContentProvider {
    ...
    static final int TRACK_WITH_ARTISTID = 101;
    ...
    /*
        ...
        match each URI to the TRACK, TRACK_WITH_ARTISTID, WEATHER_WITH_LOCATION_AND_DATE,
        and ARTIST integer constants defined above.  You can test this by uncommenting the
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, AppContract.PATH_TRACKS, TRACK);
        matcher.addURI(authority, AppContract.PATH_TRACKS + "/*", TRACK_WITH_ARTISTID);
    ...
    /*
        Students: We've coded this for you.  We just create a new AppDbHelper for later use
        here.
     */
    @Override
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case ARTIST:
                rowsDeleted = db.delete(
                        ArtistEntry.TABLE_NAME, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    ...
    public int update(
        ...
        switch (match) {
            case TRACK:
                ...
                break;
            case ARTIST:
                rowsUpdated = db.update(ArtistEntry.TABLE_NAME, values, selection,
                        selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
    ...
    public  int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        switch (match) {
            case TRACK:
                ...
                getContext().getContentResolver().notifyChange(uri, null);
                return returnTrackCount;
            case ARTIST:
                db.beginTransaction();
                int returnArtistCount = 0;
                try {
                    for (ContentValues value : values) {
